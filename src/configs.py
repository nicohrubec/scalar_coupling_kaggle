...
molecules_fin = data_folder / 'molecules.npy'
molecules_fin_debug = data_folder / 'molecules_debug.npy'
types_fin = data_folder / 'types.npy'
types_fin_debug = data_folder / 'types_debug.npy'
